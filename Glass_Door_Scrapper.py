# -*- coding: utf-8 -*-
"""
Created on Sun Aug 21 02:12:17 2022
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            ...
            button = driver.find_element(By.CLASS_NAME, "selected")
        ...
        #job_buttons = driver.find_elements("class_name", "jl")
        ...
        try:
            from selenium.webdriver.common.by import By
            driver.find_element(by=By.XPATH, value='.//li[@class="next"]//a')
